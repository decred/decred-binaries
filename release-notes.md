...
See manifest-v1.6.1.txt, and the package specific manifest files for sha256 sums and the associated .asc files to confirm those shas.
...
server. [8ce328](https://github.com/decred/dcrdex/commit/8ce328cacc4d7b0d35973a39917eef48ac1d1d64)
...
* The client's database subsystem is always started first and stopped last.
  [b4ef3f](https://github.com/decred/dcrdex/commit/b4ef3ff01f3a1567aecf762c5db75f83a9687d64) This is a prerequisite for the
  following wallet lock-on-shutdown change.
...
* Fix a possible interruption of the DEX reconnect loop if the config response
  timed out. [4df683](https://github.com/decred/dcrdex/commit/4df683a10d755d71f37c979655b6ceea6343db8d)
